...
void ioint_configure(uint8_t port, uint8_t pin, enum trigger_type trigger, uint8_t trigger_state, callback_fn callback)
{
    (void) port;
    ...
    LL_SYSCFG_SetEXTISource(syscfg_exti_ports[port], syscfg_exti_lines[pin]);
